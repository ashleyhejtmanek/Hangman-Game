...
/**
 * The picture used for the "executioner" was originally found at http://www.geocities.com/spunk1111/haloween.htm
 * I then used print screen and Microsoft Paint to create the png used here.
 * 
 * @author Ashley Hejtmanek
 * @version May 9, 2013
 */
public class Executioner extends JPanel
{
    ...
    public BufferedImage loadImage()
    {
        ...
        File file = new File("grimReaper.png");
